...
<img src="/assets/posts/diagrams/renewal-uplift.svg" alt="Applying a standard renewal uplift to pricing" width="640" height="220" loading="lazy" decoding="async" />
...
**How do I create a renewal quote in HubSpot?**
Open the renewal deal, create a quote, pull in the existing line items, set the new contract term, apply any uplift or discount, and send it for signature.

**What is a renewal uplift?**
A planned price increase applied at renewal, usually a fixed percentage, to account for inflation, expanded usage, or moving off a legacy discount.

**Can I automate renewal quotes in HubSpot?**
Yes. A workflow can pre-create a draft quote with last year's line items and a default uplift when the renewal enters its window, leaving the rep to review and send.

**How do I handle a downgrade at renewal?**
Reflect the reduced seats or tier on the renewal quote and update the renewal amount so your forecast and reporting stay accurate.
